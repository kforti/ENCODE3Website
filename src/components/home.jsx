    ...
    return (
        <div className="row">
            <div className="col-xs-12">	
                ...
                <p><em>ENCODE Phase III: Building an Encyclopaedia of candidate Regulatory Elements for Human and Mouse</em> describes the expansion of data production during ENCODE Phase III and introduces the Registry of Candidate Regulatory Elements (cREs), the core of the Encyclopedia’s integrated level. The cREs are a collection of DNase hypersensitivity sites supported by the histone modifications H3K4me3 and H3K27ac or CTCF binding. They are divided into groups, including cREs with enhancer-like signatures, promoter-like signatures, and cREs bound by CTCF, on the basis of these epigenomic marks (see Figure 4, <em>Figures</em> tab).</p>
                <p>Searching and visualization of cREs within the Registry is enabled by SCREEN (Search Candidate Regulatory Elements by ENCODE), a web-based tool accessible at <a href="http://screen.encodeproject.org/">http://screen.encodeproject.org/</a>. SCREEN also presents gene expression data associated with the cREs and the intersection between SNPs from GWAS and the cREs, and facilitates visualization of both integrated and ground-level annotations using the UCSC genome browser. Together, these features represent a powerful tool for the generation of biological hypotheses using ENCODE data (see Figure 5, <em>Figures</em> tab).</p>

                <h3>How to use this site</h3>
                <p>This companion site provides useful links to information related to the ENCODE Encyclopedia and the cREs. In addition, the site provides rich, interactive versions of all published figures, supplementary figures, and tables from the Phase III paper. SCREEN can replicate many of these published figures, using not only the data and genomic regions presented in the Phase III paper but also all other data and genomic regions cataloged by the Encyclopedia. To see this in action, simply click the <em>Figures</em> or <em>Extended Data Figures</em> tab above and then click the figure links at the top of the tab to select a figure of interest. Interactive figures will have a blue information box above them describing their interactive features; simply follow the instructions contained in the information boxes to see the corresponding views on SCREEN. Examples of interactive figures include Figures 5, 6, and 7.</p>
	            ...
	            <h3>Useful Links</h3>
                <h4><em>SCREEN and Registry links</em></h4>
                SCREEN homepage: <a href="http://screen.encodeproject.org">http://screen.encodeproject.org</a><br/>
                SCREEN GWAS: <a href="http://screen.encodeproject.org/gwasApp/hg19">http://screen.encodeproject.org/gwasApp/hg19</a><br/>
	            Registry GitHub: <a href="https://github.com/weng-lab/encode_encyclopedia_v4/">https://github.com/weng-lab/encode_encyclopedia_v4/</a><br/>
